...
public class AoC7 {
    ...
    public static void main(String[] args) {
        List<String> lines = Reader.readFromFile("src/daySeven/Day7TestInput.txt");
        assert lines != null;
    ...
    public static void partTwo(List<String> lines) {
        ...
        handList.sort(Comparator.comparingInt(AoC7::findHandType2));
        for(int i = 0; i < handList.size() / 2; i++) {
            sortHandsByCards2(handList);
        }
    ...
    public static void sortHandsByCards2(List<String> handList) {
            ...
            if(findHandType(hand1) == findHandType(hand2)) {
                for(int j = 0; j < hand1.length(); j++) {
                    if(hand1.charAt(j) != hand2.charAt(j)) {
                        int hand1Card = partTwoHandMap.get(Character.toString(hand1.charAt(j)));
                        int hand2Card = partTwoHandMap.get(Character.toString(hand2.charAt(j)));
    ...
    public static int findHandType2(String hand) {
